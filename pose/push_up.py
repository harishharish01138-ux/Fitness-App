...
def generate_frames(target_reps=None):
    """
    Yields MJPEG-encoded frames with live push-up counting overlaid.
    Counting logic: tracks the vertical gap between elbow (id 14) and
    the upper-body reference point (id 0) — original reference-video
    comparison removed since no reference clips ship with this build.
    """
    ...
    try:
        while cap.isOpened():
            ...
            cv2.putText(img, f"Push-ups: {count}", (30, 50), cv2.FONT_HERSHEY_DUPLEX, 1.1, (60, 100, 255), 3)
